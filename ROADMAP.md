...
| Benchmarks on real datasets | ✅ 9 datasets in `docs/benchmarks.md` (`creditcard` pending — network) |
...
- [x] **1.3** Run it. Expect a few minutes for `creditcard` (285k rows → sampled to 50k).
